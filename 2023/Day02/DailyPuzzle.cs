...
internal class DailyPuzzle : IDailyPuzzle
{
    ...
    /// <para>Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red</para>
    /// <para>Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green</para>
    /// <para>In game 1, the game could have been played with as few as 4 red, 2 green, and 6 blue cubes.If any color had even one fewer cube, the game would have been impossible.</para>
    /// <para>Game 2 could have been played with a minimum of 1 red, 3 green, and 4 blue cubes.</para>
    /// <para>Game 3 must have been played with at least 20 red, 13 green, and 6 blue cubes.</para>
    /// <para>Game 4 required at least 14 red, 3 green, and 15 blue cubes.</para>
    /// <para>Game 5 needed no fewer than 6 red, 3 green, and 2 blue cubes in the bag.</para>
